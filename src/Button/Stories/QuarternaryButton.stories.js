...
export default {
	title: 'Buttons/Quarternary',
	component: Button,
	argTypes: {},
};

const Template = (args) => <Button quarternary {...args} />;
export const QuarternaryButton = Template.bind({});
QuarternaryButton.args = {
	children: 'Quarternary',
	disabled: false,
};

const IconButtonTemplate = (args) => <IconButton quarternary {...args} />;
...
const FullWidthTemplate = (args) => <Button quarternary {...args} />;
...
const FullWidthIconTemplate = (args) => <IconButton quarternary {...args} />;
